...
class WSISegmentationDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, type, transforms=None, img_suffix='.jpg', seg_map_suffix='.png'):
        ...
        self.classes = ['_background_', 'cancerous', 'paracancerous']
...
if __name__ == '__main__':
    ...
    image = Image.open('../../datasets/Segmentation/JPEGImages/i0_j0_d16df010127373fffff.jpg')
    image.show()
    mask1 = Image.open('../../datasets/Segmentation/SegmentationClass/i0_j0_d16df010127373fffff.png').convert('P')
    mask1.show()
    import numpy as np
