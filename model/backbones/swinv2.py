...
if __name__ == '__main__':
    ...
    m = create_feature_extractor(model, return_nodes=return_nodes)

    x = torch.randn((1, 3, 256, 256))
    out = m(x)
    print(x.shape)             # [1, 3, 256, 256]
    print (out['out1'].shape)  # [1, 64, 64, 96]
    print (out['out2'].shape)  # [1, 32, 32, 192]
    print (out['out3'].shape)  # [1, 16, 16, 384]
    print (out['out4'].shape)  # [1, 8, 8, 768]
    print (out['out'].shape)   # [1, 8, 8, 768]
